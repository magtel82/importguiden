        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
          ...
          <div>
            ...
            <ul className="mt-2 space-y-1 text-sm text-gray-500">
              <li><Link href="/importera-bil/tyskland" className="hover:text-blue-700">Importera bil från Tyskland</Link></li>
              <li><Link href="/importera-husbil/tyskland" className="hover:text-blue-700">Importera husbil från Tyskland</Link></li>
              <li><Link href="/kalkylator/bilimport" className="hover:text-blue-700">Importkalkylator</Link></li>
              <li><Link href="/guider/registreringsbesiktning" className="hover:text-blue-700">Registreringsbesiktning</Link></li>
            </ul>
          </div>
          <div>
            ...
            <p className="mt-4 text-xs text-gray-400">
              Importguiden finansieras delvis via affiliate-länkar (märkta med *).
